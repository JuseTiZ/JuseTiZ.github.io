setInterval(() => {
  ...
  if ((Number(time[2])<22) && (Number(time[2])>7)){
    currentTimeHtml ="<img class='boardsign' src='https://img.shields.io/badge/%E2%99%82-Juse%20%E6%89%93%E5%B7%A5%E4%B8%AD-blue' title='为了科研加油吧'><div id='runtime'>" + time[0] + ' YEAR ' + time[1] + ' DAYS ' + time[2] + ' : ' + time[3] + ' : ' + time[4] + '</div><br>这个博客竟然已经运行了那么久了<br>以后也请多关照';
  }
  else{
